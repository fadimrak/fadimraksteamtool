...
const I18N = {
  tr: {
    ...
    'onlinefix.btn_spacewar': '🎮 Spacewar (AppID 480)',
    'onlinefix.guide_title': 'Online Fix Nedir ve Nasıl Çalışır?',
    'onlinefix.guide_desc': 'Online-Fix, oyunları arkadaşlarınızla resmi veya özel sunucularda çok oyunculu (multiplayer) oynamanızı sağlayan fix paketleridir. Başka bir web sitesine gitmeden doğrudan uygulama içinden arayabilir, tek tıkla indirebilir ve kurulu oyununuza kurabilirsiniz.',
    'onlinefix.tab_search': 'Online Fix Ara & İndir',
    'onlinefix.tab_installed': 'Yüklü Steam Oyunlarım',
    'onlinefix.tab_manual': 'Manuel Arşiv Seçimi',
    'onlinefix.search_placeholder': 'Online-Fix oyunlarında ara (Örn: Lethal Company)...',
    'onlinefix.btn_search': 'Ara',
    'onlinefix.popular_tags': 'Popüler:',
    'onlinefix.search_loading': 'Resmi online-fix.me taranıyor…',
    'onlinefix.search_empty_title': 'Sonuç Bulunamadı',
    'onlinefix.search_empty_desc': 'Farklı bir anahtar kelimeyle veya İngilizce oyun adıyla arama yapmayı deneyin.',
    'onlinefix.btn_refresh_installed': '↺ Listeyi Yenile',
    'onlinefix.btn_inspect_install': 'Fix Kur',
    'onlinefix.loading_fixes': 'Fix kaynakları taranıyor…',
    'onlinefix.modal_folder_label': "Hedef Oyun Klasörü (.exe'nin olduğu yer):",
    'onlinefix.btn_browse_folder': 'Gözat…',
    'onlinefix.quick_select_label': 'Veya yüklü oyun seç:',
    'onlinefix.select_installed_game': '— Bilgisayardaki Steam Oyunları —',
    'onlinefix.fix_source_label': 'İndirme Kaynağı:',
    'onlinefix.no_direct_fix': 'Doğrudan indirilebilir Fix Repair linki bulunamadı.',
    'onlinefix.default_desc': 'Online-Fix.me tarafından sağlanan çok oyunculu fix paketi.',
    'onlinefix.warn_missing_fields': 'Eksik Bilgi',
    'onlinefix.warn_missing_desc': 'Lütfen oyun klasörünü ve indirme kaynağını seçin.',
    'onlinefix.status_downloading': 'Fix paketi resmi sunucudan indiriliyor…',
    'onlinefix.status_extracting': 'Arşiv şifresiyle oyun klasörüne çıkartılıyor…',
    'onlinefix.btn_start_install': '⬇ Tek Tıkla İndir & Kur',
    'onlinefix.success_title': 'Fix Başarıyla Kuruldu!',
    'onlinefix.success_desc': "Oyun klasörünüz güncellendi. Steam'inizin açık olduğundan emin olun ve oyunu başlatın.",
    'onlinefix.btn_launch_game': '▶ Oyunu Başlat',
    'onlinefix.btn_uninstall_fix': "✕ Fix'i Kaldır (Geri Al)",
    'onlinefix.toast_game_launched': 'Oyun Başlatıldı',
    'onlinefix.confirm_uninstall_title': "OnlineFix'i Kaldır",
    'onlinefix.confirm_uninstall_msg': 'OnlineFix dosyaları silinecek ve orijinal oyun dosyaları geri yüklenecektir. Emin misiniz?',
    'onlinefix.toast_uninstalled': 'Fix Kaldırıldı',
    'onlinefix.toast_uninstalled_desc': '{count} adet orijinal dosya geri yüklendi.',
    'onlinefix.scanning_installed': 'Yüklü Steam oyunları taranıyor…',
    'onlinefix.installed_count': '{count} adet yüklü oyun bulundu',
    'onlinefix.scan_error': 'Oyunlar taranamadı.',
    'onlinefix.no_steam_games': 'Steam kütüphanenizde yüklü oyun bulunamadı.',
    'onlinefix.btn_search_fix': 'Fix Ara',
    ...
    'settings.lang_desc': 'Uygulama arayüz dilini Türkçe veya İngilizce olarak ayarlayın.',
  ...
  en: {
    ...
    'onlinefix.guide_desc': 'Online-Fix packages enable multiplayer gaming on official or custom servers with friends for cracked games. Search, download, and install fixes directly in the app without visiting any external websites.',
    'onlinefix.tab_search': 'Search & Install Online Fix',
    'onlinefix.tab_installed': 'My Installed Steam Games',
    'onlinefix.tab_manual': 'Manual Archive Selection',
    'onlinefix.search_placeholder': 'Search Online-Fix games (e.g. Lethal Company)...',
    'onlinefix.btn_search': 'Search',
    'onlinefix.popular_tags': 'Popular:',
    'onlinefix.search_loading': 'Scanning official online-fix.me…',
    'onlinefix.search_empty_title': 'No Results Found',
    'onlinefix.search_empty_desc': 'Try searching with different keywords or English game title.',
    'onlinefix.btn_refresh_installed': '↺ Refresh List',
    'onlinefix.btn_inspect_install': 'Install Fix',
    'onlinefix.loading_fixes': 'Scanning fix sources…',
    'onlinefix.modal_folder_label': 'Target Game Directory (Where .exe is located):',
    'onlinefix.btn_browse_folder': 'Browse…',
    'onlinefix.quick_select_label': 'Or select installed game:',
    'onlinefix.select_installed_game': '— Installed Steam Games on PC —',
    'onlinefix.fix_source_label': 'Download Source:',
    'onlinefix.no_direct_fix': 'No direct Fix Repair download link found.',
    'onlinefix.default_desc': 'Multiplayer fix package provided by Online-Fix.me.',
    'onlinefix.warn_missing_fields': 'Missing Information',
    'onlinefix.warn_missing_desc': 'Please select both game directory and download source.',
    'onlinefix.status_downloading': 'Downloading fix package from official server…',
    'onlinefix.status_extracting': 'Extracting archive with password to game folder…',
    'onlinefix.btn_start_install': '⬇ One-Click Download & Install',
    'onlinefix.success_title': 'Fix Installed Successfully!',
    'onlinefix.success_desc': 'Game directory updated. Ensure Steam is running and launch the game.',
    'onlinefix.btn_launch_game': '▶ Launch Game',
    'onlinefix.btn_uninstall_fix': '✕ Uninstall Fix (Restore)',
    'onlinefix.toast_game_launched': 'Game Launched',
    'onlinefix.confirm_uninstall_title': 'Uninstall OnlineFix',
    'onlinefix.confirm_uninstall_msg': 'OnlineFix files will be removed and original files will be restored. Are you sure?',
    'onlinefix.toast_uninstalled': 'Fix Uninstalled',
    'onlinefix.toast_uninstalled_desc': '{count} original files restored.',
    'onlinefix.scanning_installed': 'Scanning installed Steam games…',
    'onlinefix.installed_count': '{count} installed games found',
    'onlinefix.scan_error': 'Failed to scan games.',
    'onlinefix.no_steam_games': 'No installed games found in Steam libraries.',
    'onlinefix.btn_search_fix': 'Search Fix',
    ...
    'settings.lang_desc': 'Change the application interface language between Turkish and English.',
...
function setLanguage(lang, saveToBackend = true) {
  ...
  // Update language toggle buttons and segmented controls
  const langSwitch = document.getElementById('lang-switch');
  if (langSwitch) {
    langSwitch.setAttribute('data-active', lang);
  }
  document.querySelectorAll('.lang-option, .lang-btn, .lang-pill').forEach(btn => {
